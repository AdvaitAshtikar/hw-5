...
> The model that performed best was the SVM model. This can because the
> data is non-linear, and SVM is good at handling non-linear data
...
> The differences between the models is that with an increase in the
> number of hidden layers, the neural network becomes more capable of
> learning non-linear decision boundaries and more complex features,
> which result in better performance on tasks that require the
